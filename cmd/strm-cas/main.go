...
func main() {
	...
	flag.StringVar(&strmRoot, "strm-root", "/strm", "root directory containing .strm files")
	flag.StringVar(&cacheDir, "cache-dir", "/cache", "directory for incomplete downloads")
	flag.StringVar(&downloadDir, "download-dir", "/download", "directory for completed downloads before CAS generation")
